...
// MITRE modification start >>>>>
$this->create('settings_groups', '/settings/groups')
	->actionInclude('settings/groups.php');
$this->create('settings_group', '/settings/group')
	->actionInclude('settings/group.php');
...
$this->create('settings_ajax_changeemail', '/settings/ajax/changeemail.php')
	->actionInclude('settings/ajax/changeemail.php');
...
/** MITRE ADDED */
$this->create('settings_ajax_notificationaddress', '/settings/ajax/notificationaddress.php')
    ->actionInclude('settings/ajax/notificationaddress.php');
$this->create('settings_ajax_getpkey', '/settings/ajax/getpkey.php')
    ->actionInclude('settings/ajax/getpkey.php');
$this->create('settings_ajax_togglelock', '/settings/ajax/togglelock.php')
    ->actionInclude('settings/ajax/togglelock.php');
/** MITRE ADDED */
