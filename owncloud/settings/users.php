...
foreach($accessibleusers as $uid => $displayName) {
	...
	$users[] = array(
		...
		"email" => OC_Preferences::getValue($uid, 'settings','email','default'),
		'error_count' => OC_User::getErrorCount($uid),
		'locked' => OC_User::getLocked($uid),
		"groups" => OC_Group::getUserGroups($uid),
		'quota' => $quota,
		'isQuotaUserDefined' => $isQuotaUserDefined,
		'subadmin' => OC_SubAdmin::getSubAdminsGroups($uid),
		'userIsAdmin' => OC_User::isAdminUser($uid),
	);
}
