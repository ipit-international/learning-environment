...
OC_Util::addScript( 'settings', 'modernizr.custom.min' );
OC_Util::addScript( 'settings', 'ph' );
...
//adding functionality for notification preferences
$notemail=OC_Preferences::getValue(OC_User::getUser(), 'settings', 'notificationEmail', '');
$notemails= explode(",",$notemail);
$noteTypesString=OC_Preferences::getValue(OC_User::getUser(), 'settings', 'notificationTypes', '');
$noteTypes= explode(",",$noteTypesString);
//end edit
...
//adding variables associated with notification preferences
$tmpl->assign('notificationEmail', $notemails);
$tmpl->assign('noteTypes', $noteTypes);
