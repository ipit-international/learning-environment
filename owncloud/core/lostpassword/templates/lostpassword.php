...
OCP\Util::addStyle('lostpassword', 'lostpassword');
	if ($_['requested']): ?>
		<div class="update"><p>
	<?php
		print_unescaped($l->t('The link to reset your password has been sent to your email.<br>If you do not receive it within a reasonable amount of time, check your spam/junk folders.<br>If it is not there, make sure you have the correct username and try again. <br> If you are sure your username is correct, and that you had a password recovery email set under your personal preferences, then ask your local administrator.'));
	?>
	</p></div>
<?php else: ?>
