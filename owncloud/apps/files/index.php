...
//    $tmpl->assign( 'userId', MC_User::getUserInfo() );
//    $tmpl->assign( 'displayName', MC_User::getDisplayName() );
//    $tmpl->assign( 'homePath', MC_User::getHomePath() );
//    $tmpl->assign( 'email', MC_User::getEmail() );
//    $tmpl->assign( 'quota', MC_User::getQuota() );
//    $tmpl->assign( 'myGroups', MC_User::getGroups() );
	$tmpl->assign( 'currentUser', \OCP\MC_User::getUserInfo() );
	$tmpl->assign( 'notificationEmails', \OCP\MC_User::getNotificationEmails() );
	$tmpl->assign( 'notificationOptions', \OCP\MC_User::getNotificationOptions() );
//	$tmpl->assign( 'agroup', \OCP\MC_Group::getGroupInfo( 'admin' ) );
//	$tmpl->assign( 'otherUser', MC_User::getUserInfo( "abc") );

//	$tmpl->assign( 'groups', MC_Group::getGroups() );
    // ---- MITRE new code end
