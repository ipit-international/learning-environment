...
<!--					NOTE: Temporary fix to allow unsharing of files in root of Shared folder -->
    ...
    <!--    mitre new code start-->
    <tfoot>
    <tr>
	    <?php
	        $currentUser = $_['currentUser'];
//	        $otherUser = $_['otherUser'];
//	        $agroup = $_['agroup'];
		?>
<!--        <td style="color:darkslategray;"><br /><br />Current user info:-->
<!--            <ul>-->
<!--                <li>user ID:  --><?php //echo $currentUser['userId'] ?><!--</li>-->
<!--                <li>&nbsp; displayName:  --><?php //echo $currentUser['displayName'] ?><!--</li>-->
<!--                <li>&nbsp; email:  --><?php //echo $currentUser['email'] ?><!--</li>-->
<!--	            <li>&nbsp; my group:  --><?php //echo $currentUser['group'] ?><!--</li>-->
<!--	            <li>&nbsp; my groups:  --><?php //echo \OCP\MC_Utils::arrayAsSqlString( $currentUser['groups'] ) ?><!--</li>-->
<!--	            <li>&nbsp; my type:  --><?php //echo $currentUser['type'] ?><!--</li>-->
<!--	            <li>&nbsp; my types:  --><?php //echo \OCP\MC_Utils::arrayAsSqlString( $currentUser['types'] ) ?><!--</li>-->
<!--	            <li>&nbsp; my country:     --><?php //echo $currentUser['country'] ?><!--</li>-->
<!--	            <li>&nbsp; my notification emails:     --><?php //echo json_encode( $_['notificationEmails'] ) ?><!--</li>-->
<!--	            <li>&nbsp; my notification types:     --><?php //echo json_encode( $_['notificationOptions'] ) ?><!--</li>-->
<!--            </ul>-->
<!--            <ul>-->
<!--                <li>all groups:-->
<!--                    -->
                    <?php
//                        echo sizeof( $_['groups'] ) . '<br />';
//                        $i = 1;
...
<!--            </ul>-->
<!--	        <ul>-->
<!--		        <li>group --><?php //echo $agroup['groupId'] ?><!--</li>-->
<!--		        <li>&nbsp; displayName: --><?php //echo $agroup['displayName'] ?><!--</li>-->
<!--		        <li>&nbsp; type:        --><?php //echo $agroup['type'] ?><!--</li>-->
<!--		        <li>&nbsp; country:     --><?php //echo $agroup['country'] ?><!--</li>-->
<!--		        <li>&nbsp; model:       --><?php //echo $agroup['model'] ?><!--</li>-->
<!--		        <li>&nbsp; option:      --><?php //echo $agroup['option'] ?><!--</li>-->
<!--		        <li>&nbsp; user(s):     --><?php //echo \OCP\MC_Utils::arrayAsSqlString( $agroup['users'] ) ?><!--</li>-->
<!--	        </ul>-->
<!--        </td>-->
    </tr>
    </tfoot>
