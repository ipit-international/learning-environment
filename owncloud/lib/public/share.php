...
class Share {
	...
	public static function shareItem($itemType, $itemSource, $shareType, $shareWith, $permissions, $itemSourceName = null) {
		...
		\OC_Log::write('OCP\Share',"RPG: shareItem args = $itemType,$itemSource,$shareType,$shareWith,$permissions,$itemSourceName", \OC_Log::INFO );
		// verify that the file exists before we try to share it
		if ($itemType === 'file' or $itemType === 'folder') {
			$path = \OC\Files\Filesystem::getPath($itemSource);
			\OC_Log::write('OCP\Share',"RPG: share path = $path ",\OC_Log::INFO );
			if (!$path) {
...
// 		}
	...
	private static function put($itemType, $itemSource, $shareType, $shareWith, $uidOwner,
		...
		\OC_Log::write('OCP\Share',"RPG: made it into put",\OC_Log::INFO );
		...
		if ($shareType == self::SHARE_TYPE_GROUP) {
			...
			\OCP\Util::writeLog("Share->Put","just emitted the post_shared hook...",4);
