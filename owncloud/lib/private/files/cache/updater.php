...
class Updater {
	...
	static public function writeUpdate($path) {
		...
		/**
		 *The following line of code added by AJROSS, MIRE Corp.
		 */
//////////////////////////////////////////////////
        	Util::writeLog("lib/private/files/cache/updater", "Now not directly calling SharingManager write from inside lib/private/files/cache/updater.  but not really its commented out",4);
//		\OCA\FileRouter\applogic\SharingManager::write(array('path'=>$path));
/////////////////////////////////////////////////
	}
